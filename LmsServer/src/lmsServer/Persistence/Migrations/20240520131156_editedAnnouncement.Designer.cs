...
namespace Persistence.Migrations
{
    ...
    [Migration("20240520131156_editedAnnouncement")]
    partial class editedAnnouncement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("878fbf1a-b594-4672-b9a3-b7e6660886af"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 31, 201, 46, 9, 142, 215, 36, 70, 20, 225, 106, 245, 228, 17, 212, 105, 175, 73, 153, 96, 158, 82, 188, 103, 90, 219, 132, 172, 79, 98, 189, 80, 85, 29, 131, 213, 42, 184, 70, 37, 198, 36, 68, 75, 167, 166, 141, 95, 65, 153, 157, 48, 151, 165, 110, 165, 226, 7, 181, 181, 239, 20, 231, 121 },
                            PasswordSalt = new byte[] { 138, 202, 32, 116, 53, 151, 137, 87, 84, 134, 67, 212, 198, 201, 57, 18, 14, 74, 232, 99, 217, 235, 10, 8, 78, 113, 23, 209, 117, 86, 16, 83, 55, 109, 128, 160, 79, 250, 139, 44, 59, 136, 237, 54, 140, 53, 207, 193, 21, 92, 150, 125, 231, 23, 130, 243, 101, 77, 47, 106, 151, 74, 66, 238, 88, 9, 73, 174, 26, 70, 203, 83, 136, 132, 45, 185, 240, 212, 33, 252, 68, 219, 63, 221, 207, 114, 2, 154, 152, 94, 243, 27, 253, 183, 116, 10, 19, 88, 78, 185, 69, 227, 61, 138, 244, 25, 221, 25, 175, 155, 124, 205, 128, 111, 25, 190, 79, 48, 73, 6, 217, 219, 106, 217, 208, 224, 34, 164 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("718bdac0-b3ad-4a4d-b84f-a8e07dc67adf"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("878fbf1a-b594-4672-b9a3-b7e6660886af")
                        });
                });
