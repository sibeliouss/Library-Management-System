...
namespace Persistence.Migrations
{
    ...
    [Migration("20240515155452_editbook")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4ba860eb-62aa-461e-bf7f-0911ca8fb3f9"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 216, 227, 156, 19, 240, 18, 200, 100, 154, 149, 220, 102, 155, 27, 26, 39, 63, 121, 175, 90, 192, 39, 212, 23, 249, 54, 104, 221, 88, 133, 206, 181, 243, 60, 242, 1, 185, 80, 214, 243, 89, 31, 66, 143, 29, 158, 0, 215, 28, 208, 184, 201, 36, 123, 174, 6, 120, 246, 196, 169, 23, 215, 187, 113 },
                            PasswordSalt = new byte[] { 18, 187, 25, 139, 248, 71, 134, 45, 200, 231, 52, 68, 235, 180, 223, 169, 89, 122, 57, 56, 22, 118, 103, 145, 219, 14, 3, 110, 224, 150, 27, 54, 23, 5, 89, 18, 37, 2, 137, 151, 20, 250, 204, 184, 141, 130, 7, 113, 150, 52, 77, 200, 54, 64, 247, 62, 213, 161, 199, 245, 118, 78, 67, 248, 243, 166, 181, 83, 190, 189, 138, 247, 112, 35, 72, 41, 52, 254, 238, 158, 183, 150, 132, 18, 172, 135, 169, 152, 197, 30, 189, 212, 112, 85, 114, 109, 235, 187, 206, 223, 60, 222, 52, 185, 24, 173, 131, 61, 150, 92, 128, 173, 5, 240, 156, 141, 56, 183, 186, 152, 19, 42, 8, 0, 37, 70, 50, 190 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b3774536-0771-4ff1-98aa-384c4fe80820"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("4ba860eb-62aa-461e-bf7f-0911ca8fb3f9")
                        });
                });
